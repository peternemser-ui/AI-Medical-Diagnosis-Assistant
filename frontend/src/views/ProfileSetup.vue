  ...
  <div class="min-h-screen transition-colors duration-300 surface-page">
    ...
    <nav class="relative z-20 flex items-center justify-between px-4 sm:px-6 py-3 border-b backdrop-blur-xl"
      ...
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <div v-if="form.name" class="relative">
          <button @click="showUserMenu = !showUserMenu" class="flex items-center gap-2 px-2 py-1.5 rounded-lg transition-colors cursor-pointer"
            ...
            <span class="text-sm font-medium hidden sm:inline">{{ form.name }}</span>
          ...
          <div v-if="showUserMenu" class="absolute right-0 top-full mt-1 w-48 rounded-lg shadow-xl border z-50 overflow-hidden py-1"
            ...
            <router-link to="/settings" @click="showUserMenu = false" class="flex items-center gap-2 px-3 py-2 text-xs transition-colors"
