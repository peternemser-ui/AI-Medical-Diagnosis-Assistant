...
const messages = {
  en: {
    ...
    diagnosis: {
      ...
      voiceInputPlaceholder: 'Type your message or use voice recording...',
      send: 'Send',
      restart: 'Start Over',
  ...
  es: {
    ...
    diagnosis: {
      ...
      voiceInputPlaceholder: 'Escribe tu mensaje o usa grabación de voz...',
      send: 'Enviar',
  ...
  fr: {
    ...
    diagnosis: {
      ...
      voiceInputPlaceholder: 'Tapez votre message ou utilisez l\'enregistrement vocal...',
      send: 'Envoyer',
      restart: 'Recommencer',
  ...
  zh: {
    ...
    diagnosis: {
      ...
      voiceInputPlaceholder: '输入您的消息或使用语音录制...',
      send: '发送',
      restart: '重新开始',
