<template>
  <div class="flex-1 overflow-hidden flex flex-col">
    ...
    >
      ...
      >
        <div
          class="max-w-[95%] sm:max-w-[85%] relative"
          :class="getMessageContainerClasses(message)"
        >
          <!-- Assistant messages -->
          <div
            v-if="message.sender === 'assistant'"
            class="backdrop-blur-sm rounded-xl rounded-tl-sm p-3 sm:p-4 shadow-lg border-l-3 border"
            :class="[
          ...
          >
            ...
            <div class="flex items-center mb-2 gap-2">
              ...
              <span class="text-[11px] text-slate-500 font-medium">Medical AI</span>
            ...
            <div class="message-content">
              ...
              <div v-else>
                <div v-if="message.text" class="whitespace-pre-wrap text-sm leading-relaxed" v-html="formatMessageText(message.text)"></div>
              </div>
            ...
            <div class="mt-2 flex items-center justify-between">
              <div class="text-[10px]" :class="isDark ? 'text-slate-600' : 'text-gray-400'">{{ formatTimestamp(message.timestamp) }}</div>
              <button
                v-if="soundEnabled"
          ...
          <div
            v-else
            class="rounded-xl rounded-br-sm px-3 sm:px-4 py-2.5 sm:py-3 shadow-lg"
            :class="isDark ? 'bg-blue-600 text-white' : 'bg-blue-500 text-white'"
          >
            <div v-if="message.text" class="whitespace-pre-wrap text-sm" v-html="formatMessageText(message.text)"></div>
            ...
            <div class="mt-1.5 text-[10px] text-blue-200/60">{{ formatTimestamp(message.timestamp) }}</div>
          </div>
        </div>
      </div>
