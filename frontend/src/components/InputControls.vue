  ...
  <div class="border-t p-4 backdrop-blur-xl" :class="isDark ? 'bg-slate-900/95 border-slate-700/50' : 'bg-white/95 border-gray-200'">
    <div class="max-w-4xl mx-auto">
      ...
      <div v-else>
        ...
        <div class="flex items-end space-x-3" role="toolbar" aria-label="Message controls">
          <!-- Sound/TTS toggle -->
          <button
            @click="emit('sound-toggle')"
          ...
          <button
            ...
            aria-label="Voice and avatar settings"
          >
          ...
          <button
            ...
            aria-label="Upload an image for visual diagnosis"
          >
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
